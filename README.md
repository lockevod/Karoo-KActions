...
3. Install the app using the command `adb install knotifyl.apk`.


If you've Karoo 3 and v > 1.527 you can sideload the app using the following steps:

1. Link with apk (releases link) from your mobile (https://github.com/lockevod/Karoo-KNotify/releases/latest/download/kpower.apk)
